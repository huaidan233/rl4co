...
landtype = ['Commercial', 'Residential', 'Office', 'Residential&Commercial', 'Green Space', 'Education', 'Hospital',
            'SOHO']
class MAlanduseOptEnv(RL4COEnvBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._num_lands = generator.num_loc
        self._num_types = generator.num_types
        self._n_ops_max = self._num_lands - generator.num_fixed
